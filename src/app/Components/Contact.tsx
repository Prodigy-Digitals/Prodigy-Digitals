...
const Contact = () => {
  ...
  <div className='flex justify-center'>
    <button className='bg-[rgba(249,227,98,1)] w-48 sm:w-56 md:w-64 rounded-full text-[rgba(28,28,28,1)] font-extrabold h-10 sm:h-12 flex justify-center items-center px-6 sm:px-7'>
      Contact Now
    </button>
  </div>
</div>
